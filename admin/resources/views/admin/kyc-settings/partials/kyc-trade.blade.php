                        ...
                        <div class="col-md-12 mt-20">
                            <div class="form-group row">
                                <div class="col-6">
                                    ...
                                    @endphp
                                    <select name="kyc_trade_setting_status" id="" class="selectpicker" title="{{ __('select option') }}" data-live-search="true" data-width="100%" data-style="btn-info" data-actions-box="true" data-selected-text-format="count > 4">
