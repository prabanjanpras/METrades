                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <div class="controls">
                                            ...
                                            <select name="network" id="network_id" class="form-control">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <div class="controls">
                                            ...
                                            <input type="text" class="form-control" name="transaction_id" value="{{isset($transaction_id) ? $transaction_id : old('transaction_id')}}">
                                        </div>
                                    </div>
                                </div>
                            </div>
