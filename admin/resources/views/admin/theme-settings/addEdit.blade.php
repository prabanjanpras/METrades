                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3 mt-20">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="color" name="user_maiuserEndColorListn_background_color" value="{{ (!empty($settings['user_main_background_color']))?$settings['user_main_background_color'] : '#ffffff'}}"/>
                                    </div>
                                </div>
                                <div class="col-md-3 mt-20">
                                    <div class="form-group">
